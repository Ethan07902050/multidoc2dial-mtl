...
class BaseTransformer(pl.LightningModule):
    ...
    def total_steps(self) -> int:
        ...
        # Assign gradient_accumulation_steps value during __init__ in manual optimization mode
        # Otherwise specify accumulation steps through command line arguments
